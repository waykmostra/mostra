...
// project.client_id pointe vers clients.id (CRM). Le user_id auth est
// dans clients.profile_id (NULL si pas de compte connectable).
...
export async function approveMoodboardSubPhase(
  ...
  void notifyClientValidation(project.id, 'Moodboard / Style validé par le client.', `/projects/${project.id}`)
