...
export default function SettingsNav() {
  ...
  return (
    <nav className="flex items-center gap-1 border-b border-line mb-6 -mt-2 overflow-x-auto -mx-4 px-4 sm:mx-0 sm:px-0 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
      {NAV.map(({ label, href }) => {
